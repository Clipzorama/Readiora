...
function FAQItem({ item, isOpen, onToggle }) {
  ...
  return (
    <motion.div
      layout
      className="landing-card-surface overflow-hidden rounded-2xl border border-border bg-card/75 transition hover:border-strong-border hover:bg-card/90"
    >
      <button
        type="button"
        onClick={onToggle}
      ...
      >
        ...
        <motion.span
          ...
          className="landing-soft-surface flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-border bg-background/75"
        >
